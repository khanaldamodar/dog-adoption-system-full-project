...
// Query to fetch active dogs that are not yet adopted
...
<?php include "Navbar.php"?>
    ...
    <section class="pet-cards">
        ...
        if ($result && $result->num_rows > 0) {
            ...
            echo "<div class='no-pets-message'>No animals are currently available for adoption. Please check back later!</div>";
        }
        ?>
    </section>
</body>
